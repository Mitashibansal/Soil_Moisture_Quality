...
class EditProfileScreen extends StatefulWidget {
  const EditProfileScreen({Key? key, this.title = 'Flutter Demo'})
      : super(key: key);
...
class _EditProfileScreenState extends StateMVC<EditProfileScreen> {
  _EditProfileScreenState() : super(Controller()) {
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: AddAvatar(
              imageSize: 80.sd,
              chooseProfilePhoto: con.pickImage,
              image: con.selectedImage,
              currentAvatarUrl: con.user?.profileUrl,
            ),
          ),
          // Align(
          //   alignment: Alignment.center,
